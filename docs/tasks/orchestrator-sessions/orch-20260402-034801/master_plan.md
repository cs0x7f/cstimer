...
- Completed: `T00 Repo coordination brief`, `T01 Vision brief and MUS split`, `T02 PRD and FR issue set`, `T03 Coding guidelines and builder prompt`, `T04 UI design system and mockup planning`, `T05 Architecture and domain boundaries`
- Next up: `T06 Persistence and export plan`
