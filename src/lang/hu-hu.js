...
var PROPERTY_SCRMONO = 'keverés elülönítve';
var PROPERTY_SCRLIM = 'a keverési terület magassága';
...
var PROPERTY_COLOR_STR = 'random|1-es stílus|2-es stílus|3-as stílus|fekete|fehér|6-os stílus|manual|import/export...';
...
var PROPERTY_VRCMPS = 'Nincs|CFOP|CF+OP|CFFFFOP|Roux';
...
var scrdata = [
	...
	['2x2x2', [
		["WCA", "222so", 0],
		['optimális véletlen állapot', "222o", 0],
		['3-gen', "2223", 25],
		['EG', "222eg", 0],
		['EG0', "222eg0", 0],
		['EG1', "222eg1", 0],
	...
	['Pyraminx', [
		["WCA", "pyrso", 10],
		['omtimális véletlen állapot', "pyro", 0],
		['véletlen mozdulatok', "pyrm", 25]
	]],
	['Skewb', [
		["WCA", "skbso", 0],
		['U L B R', "skb", 25]
...
var STATS_SSMGR_OPS = 'Átnvezés|Létrehozás|Szétválasztás|Egybevonás|Törlés';
