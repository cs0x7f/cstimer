...
<li><strong data="opt_input">Zeiten eintragen mit</strong>. csTimer is able to add solves by several ways, it supports manually input, automatically record from a stackmat timer, connect to a bluetooth smart cube or play virtual Rubik's cube, besides keyboard timing.</li>
<li><strong data="opt_intUN">Einheit bei der Eingabe einer Zahl</strong>. When you type an integer XXX in the input box, what does it mean, XXX second or XXX centisecond or XXX millisecond?</li>
<li><strong data="opt_timeU">Timer-Update ist</strong>. How timer is updated when timing.</li>
<li><strong data="opt_preTime">wie lange die Leertaste drücken (Sekunde(n))</strong>. How long the space bar should be held before the timer turns green.</li>
<li><strong data="opt_phases">Multi-Phase</strong>. Number of phases, press any key to mark a split point when timing.</li>
<li><strong data="opt_stkHead">Benutze die Stackmat Statusinformationen</strong>. Stackmat will report its state, e.g. whether left or right area is touched, then csTimer is able to use these information, however, the data error might occur and cause unexpected behavior.</li>
<li><strong data="opt_scrSize">Scramble-Größe</strong>. Size of the scramble text.</li>
...
<li><strong data="opt_scrLim">Die Höhe des Scramble-Bereichs begrenzen</strong>. When the scramble area is too high, a scroll bar will occur to avoid the raising of the scramble panel.</li>
<li><strong data="opt_scrAlign">Aurichtung des Scramble-Bereichs</strong>. Alignment of the whole scramble area, include scramble type selector.</li>
...
<li><strong data="opt_scrFast">schnellen Scramble für 4x4x4 verwenden (inoffiziell)</strong>. WCA official 4x4x4 scramble requires huge computation resources, select this option to use a random-move scramble for 4x4x4 instead.</li>
...
<li><strong data="opt_scrClk">Aktion beim klicken des scrambles</strong>. Behavior when you click on the scramble text, copy scramble or generate next scramble.</li>
<li><strong data="opt_trim">Anzahl der Versuche, die auf beiden Seiten getrimmt wurden</strong>. Number of solves trimmed at head and tail of solves when calculating average.</li>
<li><strong data="opt_statsum">Zusammenfassung vor der Zeiten-Liste anzeigen</strong>. Show the statistics table before time list.</li>
<li><strong data="opt_printScr">Scramble(s) in den Statistiken anzeigen</strong>. Print scramble in round statistics dialog.</li>
<li><strong data="opt_printDate">Datum des Solves in den Statistiken anzeigen</strong>. Print solving date in round statistics dialog.</li>
<li><strong data="opt_imrename">Sitzung direkt nach der Erstellung umbenennen</strong>. Immediately rename a session after creating it.</li>
<li><strong data="opt_scr2ss">neue Sitzung erstellen, wenn Scramble-Typ gewechselt wird</strong>. When switching scramble type, a new session will be created.</li>
<li><strong data="opt_statinv">umgekehrte Zeitliste</strong>. Invert the time list, thus, latest solves will at the bottom of the time list.</li>
...
<li><strong data="opt_giiAED">Automatische Hardware-Fehler-Erkennung</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">Scramble-Generator</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Zeit bestätigen</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">sitzungsübergreifende Statistiken</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Statistiken</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Zeitverteilung</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Zeit-Trend</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">Scramble zeichnen</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Roux ersten Block lösen</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; EOLine Lösen</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; Kreuz lösen</strong>. TO_BE_FILLED</li>
