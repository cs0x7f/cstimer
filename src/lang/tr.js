...
var PROPERTY_ENTERING_STR = 'kronometre|yazma|stackmat|MoYuTimer|sanal|Giiker';
...
var PROPERTY_COLOR_STR = 'rastgele|stil 1|stil 2|stil 3|siyah|beyaz|stil 6|manual|dışa aktar...|içe aktar...';
...
var scrdata = [
	...
	['15 puzzle', [
		['parça hamleleri', "15p", 80],
		['boşluk hamleleri', "15pm", 80]
	]],
	['LxMxN', [
...
var STATS_CFM_DELSS = 'bu sezonu sil?';
...
var STATS_SESSION_NAME = 'sezon ismi';
var STATS_STRING = 'en iyi|şu anki|en kötü|CsTmier tarafından %Y-%M-%D günü oluşturuldu|tamamlanan çözümler/toplam: %d|tek çözüm |%mk çözümün genel ortalaması|%mk çözümün ortalaması|ortalama: %v{ (σ = %sgm)}|genel ortalama: %v|Süreler:|solving from %s to %e';
