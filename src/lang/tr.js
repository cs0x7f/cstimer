...
var STATS_STRING = 'en iyi|şu anki|en kötü|CsTmier tarafından %Y-%M-%D günü oluşturuldu|tamamlanan çözümler/toplam: %d|tek çözüm |%mk çözümün genel ortalaması|%mk çözümün ortalaması|ortalama: %v{ (σ = %sgm)}|genel ortalama: %v|Süreler:';
