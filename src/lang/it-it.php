...
<ul>
<li><strong data="opt_ahide">Nascondi tutti gli elementi quando mi cronometro</strong>. Hide logo and all panels when timing.</li>
...
<li><strong data="opt_timeFormat">Formato tempo</strong>. Time format to display.</li>
...
<li><strong data="opt_font">Seleziona il carattere del cronometro</strong>. Font of the main timer.</li>
...
<li><strong data="opt_view">Lo stile dell'interfaccia è</strong>. Switch between desktop and mobile views.</li>
...
<li><strong data="opt_useKSC">Usa abbreviazioni da tastiea</strong>. Use keyboard shortcut to switch scramble type, generate next scramble, switch between sessions, etc.</li>
...
<li><strong data="opt_giiAED">Rilevazione automatica errori hardware</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">Generatore di scramble</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Conferma tempo</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">Statistiche cross-session</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Statistiche</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Distribuzione temporale</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">trend dei tempi</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">Disegna scramble</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Risoluzione Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; Risoluzione EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; Risoluzione croce</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_giikerutil">Cubo Giiker</strong>. TO_BE_FILLED</li>
<li><strong data="tool_if">InsertionFinder</strong>. TO_BE_FILLED</li>
<li><strong data="tool_mtrnm">metronomo</strong>. TO_BE_FILLED</li>
