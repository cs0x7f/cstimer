<h1>csTimer (Έκδοση <?php echo $version;?>) - Χρονόμετρο για Speedcubing</h1>
<?php include('lang.php') ?>
<h2>Εισαγωγή</h2>
<p>Το csTimer είναι ένα ειδικά σχεδιασμένο χρονόμετρο που έχει σχεδιαστεί αποκλειστεικά για όλους τους γρήγορους λύτες του κύβου του Rubik. Το csTimer σας παρέχει:</p>
<ul>
...
<li><strong data="opt_wndScr">Στυλ εμφάνισης πίνακα ανακατέματος</strong>. Make scramble panel embedded into background.</li>
<li><strong data="opt_wndStat">Στυλ εμφάνισης πίνακα στατιστικών</strong>. Make list times panel embedded into background.</li>
