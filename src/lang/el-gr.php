...
<li><strong data="opt_useMilli">χρησιμοποίησε κλάσματα δευτερολέπτου</strong>. Display the millisecond digit, no matter whether it is checked, the internal timing accuracy of csTimer is 1 millisecond.</li>
...
<li><strong data="opt_zoom">Μεγέθυνση</strong>. You can adjust sizes of all elements by this option.</li>
...
<li><strong data="opt_timerSize">μέγεθος του χρονομέτρου</strong>. Set the size of main timer.</li>
<li><strong data="opt_smallADP">χρησιμοποίησε μικρό φόντο μετά τα δέκατα</strong>. Use a smaller font size after the digital point in main timer.</li>
<li><strong data="opt_useMouse">use mouse timer</strong>. Use mouse to start timer, keyboard-trigger will also be available.</li>
<li><strong data="opt_useIns">χρησιμοποίησε επιθεώρηση του WCA</strong>. Enable WCA inspection procedure, which is a 15-second countdown, auto +2/DNF penalty will also be enabled if you inspecting more than 15 seconds.</li>
<li><strong data="opt_voiceIns">ηχητική ειδοποίηση για επιθεώρηση του WCA</strong>. Alert at 8s/12s of inspection, to simulate the alert from judge in WCA competitions.</li>
...
<li><strong data="opt_phases">με πολλές φάσεις</strong>. Number of phases, press any key to mark a split point when timing.</li>
...
<li><strong data="opt_scrSize">μέγεθος μπερδέματος</strong>. Size of the scramble text.</li>
...
<li><strong data="opt_scrMono">μπέρδεμα χωρίς κενά</strong>. Use monospaced font for scramble text.</li>
...
<li><strong data="tool_stats">Statistics</strong>. TO_BE_FILLED</li>
