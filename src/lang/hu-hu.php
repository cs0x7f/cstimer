...
<ul>
<li><strong data="opt_ahide">Összes elem elrejtése mérés közben</strong>. Hide logo and all panels when timing.</li>
<li><strong data="opt_useMilli">milliszekundum használata</strong>. Display the millisecond digit, no matter whether it is checked, the internal timing accuracy of csTimer is 1 millisecond.</li>
<li><strong data="opt_timeFormat">idő formátum</strong>. Time format to display.</li>
<li><strong data="opt_atexpa">Automatikus exportálás (100 kirakásonként)</strong>. If checked, csTimer will export the solves automatically per 100 solves to the specified place, local file, csTimer server, or Google Storage.</li>
<li><strong data="opt_expp">A régebbi adatok importálása</strong>. If you've uploaded multiple backups, you can import from one of the up to 10 most recently uploaded backups, if you accidentally upload an empty backup, this option will help you retrieve your solves.</li>
...
<li><strong data="opt_scrMono">állandó szélességű keverés</strong>. Use monospaced font for scramble text.</li>
...
<li><strong data="opt_giiAED">Automatikus hardver hiba érzékelés</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">KeverésGenerátor</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Idő megerősítése</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">több szakasz statisztikái</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Statisztikák</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">idő megoszlása</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">idő trend</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">Keverés mutatása</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Roux S1 megoldása</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; EOLine megoldása</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; kereszt megoldása</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_mtrnm">metronóm</strong>. TO_BE_FILLED</li>
<li><strong data="tool_onlinecomp">Online verseny</strong>. TO_BE_FILLED</li>
