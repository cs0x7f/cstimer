...
var PROPERTY_SCRNEUT_STR = 'Nessuno|Faccia singola|Faccia doppia|Sei facce';
var PROPERTY_SCREQPR = 'Probabilità degli stati negli scamble di training';
var PROPERTY_SCREQPR_STR = 'Attuale|Equiprobabili|Ordine casuale';
...
var PROPERTY_SCRCLK = 'Azione predefinita al click sullo scramble';
...
var TOOLS_TRAINSTAT = 'Statistiche Training';
...
var TOOLS_SYNCSEED_HELP = 'Se abilitato, lo scramble dipenderà solo dal seme e dai settaggi scramble.';
var TOOLS_SYNCSEED_DISABLE = 'Disabilita seme corrente?';
var TOOLS_SYNCSEED_INPUTA = 'Inserisci un valore (a-zA-Z0-9) come seme';
var TOOLS_BATTLE = 'Battaglia online';
var TOOLS_BATTLE_HEAD = 'Stanza|Entra nella Stanza';
var TOOLS_BATTLE_TITLE = 'Rango|Stato|Tempo';
var TOOLS_BATTLE_STATUS = 'Pronto|Ispezione|Risoluzione|Risolto|Perso';
var TOOLS_BATTLE_INFO = 'Entra in una stanza da battaglia con il tuo amico, e combatterete insieme.';
var TOOLS_BATTLE_JOINALERT = 'Per favore inserisci l\'ID della stanza';
var TOOLS_BATTLE_LEAVEALERT = 'Lascia la stanza corrente';
var OLCOMP_UPDATELIST = 'Aggiorna la Lista delle Competizioni';
var OLCOMP_VIEWRESULT = 'Guarda il Risultato';
...
var OLCOMP_ABORT = 'Termina la competizione e mostra i risultati?';
...
var PROPERTY_VRCORI = 'Orientameento cubo virtuale';
...
var PROPERTY_GIIMODE = 'Modalità Cubo Bluetooth';
var PROPERTY_GIIMODES = 'Normale|Training|Training continuo';
var PROPERTY_VRCAH = 'Pezzi non usati in un cubo grande';
var PROPERTY_VRCAHS = 'Nascondi|Bordo|Colore|Mostra';
...
var SCROPT_BTNALL = 'Completo';
var SCROPT_BTNNONE = 'Azzerato';
...
var PROPERTY_STATTHRES = 'Mostra tempo target per migliorare la sessione';
...
var PROPERTY_HLPBS_STR = 'Arancione scuro come WCA|Come colore del link|Spesso|Nessuno';
...
var PROPERTY_TRIMR = 'Numero di soluzioni eliminate dal lato peggiore';
var PROPERTY_TRIM_MED = 'Mediana';
var PROPERTY_STKHEAD = 'Usa informationi sullo stato dello Stackmat';
var PROPERTY_TOOLPOS = 'Posizione del pannello degli strumenti';
var PROPERTY_TOOLPOS_STR = 'Basso|Libero|Alto';
var PROPERTY_HIDEFULLSOL = 'Mostra la soluzione progressivamente';
var PROPERTY_IMPPREV = 'Importa dati precedenti';
var PROPERTY_AUTOEXP = 'Auto Export (ogni 100 risoluzioni)';
var PROPERTY_AUTOEXP_OPT = 'Mai|In File|Con csTimer ID|Con WCA Account|Con Google Account|Solo Avviso';
...
var VRCREPLAY_SHARE = 'condividi link';
var GIIKER_CONNECT = 'Premi per connetterti';
var GIIKER_RESET = 'Reset (Segna come Risolto)';
var GIIKER_REQMACMSG = 'Per favore inserisci il MAC address del tuo smart hardware (xx:xx:xx:xx:xx:xx). Puoi trovare il MAC address usando chrome://bluetooth-internals/#devices, o modificando l\'opzione seguente in modo che csTimer lo rilevi automaticamente:\nChrome: In chrome://flags/#enable-experimental-web-platform-features\nBluefy: Abilita Enable BLE Advertisements';
var GIIKER_NOBLEMSG = 'Bluetooth API non disponibile. Verifica accesso https, controlla che bluetooth sia abilitato sul tuo device, e prova con chrome chrome://flags/#enable-experimental-web-platform-features enabled';
var PROPERTY_SHOWAD = 'Mostra avvisi (ha effetto dopo il riavvio)';
var PROPERTY_GIIORI = 'Orientamento Cubo';
var LGHINT_INVALID = 'Valore Invalidp!';
var LGHINT_NETERR = 'Errore Network!';
var LGHINT_SERVERR = 'Errore Server!';
var LGHINT_SUBMITED = 'Inviato';
var LGHINT_SSBEST = 'Migliore sessione %s!';
var LGHINT_SCRCOPY = 'Scramble copiato';
var LGHINT_LINKCOPY = 'Link di condivisione copiato';
var LGHINT_SOLVCOPY = 'Soluzione copiata';
var LGHINT_SORT0 = 'Già ordinato';
var LGHINT_IMPORTED = 'Import %d sessioni';
var LGHINT_IMPORT0 = 'Nessuna sessione importata';
var LGHINT_BTCONSUC = 'Bluetooth connesso con successo';
var LGHINT_BTDISCON = 'Bluetooth disconnesso';
var LGHINT_BTNOTSUP = 'Smart cube non supportato';
var LGHINT_BTINVMAC = 'MAC address non valido, non riesco a connettermi al tuo cubo smart';
var LGHINT_AEXPABT = 'Auto export interrotto';
var LGHINT_AEXPSUC = 'Auto export completato con successo';
var LGHINT_AEXPFAL = 'Auto export fallito';
var EASY_SCRAMBLE_HINT = 'Cambia la lunghezza per inserire un limite superiore alla lunghezza della soluzione, inserisci 2 cifre per limitare anche inferiormente (<= 8)';
