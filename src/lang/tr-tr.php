...
<li><strong data="tool_distribution">Süre dağılımı</strong>. Time distribution and stability analysis, &lt;X Y/Z means there are totally Y solves less than X seconds, and all of the latest Z solves are less than X seconds in the session.</li>
...
<li><strong data="tool_roux1">Solvers &gt; Roux S1 çözümü</strong>. Roux 1st step solver, which solves a 1x2x3 block.</li>
<li><strong data="tool_eoline">Solvers &gt; EO Line çözümü</strong>. EO line solver, which solves orientations of all 12 edges, and positions of DF and DB edges.</li>
<li><strong data="tool_cross">Solvers &gt; cross çözümü</strong>. Cross solver, which solve DF, DL, DR, DB edges.</li>
