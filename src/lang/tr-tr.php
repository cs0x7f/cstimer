...
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">karıştırma oluşturucu</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_stats">İstatistikler</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Süre dağılımı</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Süre grafiği</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">karıştırmayı göster</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Roux S1 çözümü</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; EO Line çözümü</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; cross çözümü</strong>. TO_BE_FILLED</li>
