...
<li><strong data="opt_giiAED">Automatická detekce hardwarové chyby</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">Generátor Zamíchání</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Potvrďte čas</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">statistiky kříže</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Statistiky</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">distribuce času</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">trend času</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">nakreslit scramble</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; složit Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; složit EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; složit kříž</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_giikerutil">Giiker kostka</strong>. TO_BE_FILLED</li>
<li><strong data="tool_if">InsertionFinder</strong>. TO_BE_FILLED</li>
<li><strong data="tool_mtrnm">metronom</strong>. TO_BE_FILLED</li>
