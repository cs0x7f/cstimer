...
<p> --- Написано: <a class="click" href="mailto:cs0x7f@gmail.com">Шуан Ченом (cs0x7f@gmail.com)</a><br>
 --- UI разработан: <a class="click" href="mailto:liebe7@126.com">Ює Чжаном (liebe7@126.com)</a><br></p>
<h2>Представление</h2>
<ul>
...
<li><b>Инструменты</b> - Поддержка сборки multi-fпace креста, Xcross(продолженный крест), EOLine. Изображение Скрамбла для NxNxN куба.</li>
</ul>
<h2>Детали</h2>
...
<h3>Скрамбл</h3>
<ul>
 <li><b>WCA Оффицальный Скрамблерr</b> - csTimer поддерживает всех официальных скрамблеров wca, как: случайная позиция скрамблер 2x2x2, 3x3x3, пирамидка, скваер, clock. Случайные движения скрамблер 4x4x4, 5x5x5, 6x6x6, 7x7x7, мегаминкс.</li>
