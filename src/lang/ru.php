<h1>csTimer версия 2018.11.05 - Профессиональный Тренировочный Таймер</h1>
<?php include('lang.php') ?>
<p>csTimer был разработан для собирающего кубера. Он поддерживает типы многих скрамблов разных головоломок включая <b>все
        офицальные пазлы WCA</b>; Он интегрировал с <b>Xcross сброщиком и eoline сборщиком</b>; Он поддерживает
    статистику времени, <b>multi-phase таймминг</b> и некоторые другие функции поддержаные другими программами как: 15с'
    рассмотр принятый WCA, и т.д.</p>
<p>Таймер неплохо работает на многих браузерах, как: chrome(рекомендованно), firefox, opera, IE7+. Также работает на
    ipad, iphone и многие устройства платформы Android. </p>
...
<h2>Представление</h2>
<ul>
    <li><b>Таймер</b> - Поддержка WCA рассмотра, multi-phase тайминг, вставка через клавиатуры, подтвердить OK/+2/DNF.
        Аккуратонсть 0.001с.
    </li>
    <li><b>Скрамбл</b> - Поддержка всех скрамблов WCA. Большое количество неофицальных и тренировочных скрамблов, как:
        ребра/углы только, последний слой.
    </li>
    <li><b>Статистика</b> - Показывает average 5/12 динамично. Загрузка статистик текущей сессии, включая лучший average
        5/12 и т.д.
    </li>
    <li><b>Инструменты</b> - Поддержка сборки multi-face креста, Xcross(продолженный крест), EOLine. Изображение
...
<h3>Таймер</h3>
<ul>
    <li><b>Традиционный</b> - Нажмите на кнопку 'пробел' пока цвет шрифта не переключится на зеленый. Время начнется
        когда вы отпустите кнопку и рекорд запишется когда вы нажмете кнопку снова.
    </li>
    <li><b>Время нажатия</b> - Также как stackmat, csTimer поддерживает время нажатия. Вы должны нажимать на кнопку
        'пробел' некоторое время прежде чем отпускать.
    </li>
    <li><b>WCA рассмотр</b> - csTimer поддерживает рассмотр как это описано в правилах wca. Если включено, таймер будет
        в режиме рассмотра после того как вы его начали.
    </li>
    <li><b>Multi-phase тайминг</b> - таймер поддерживает multi-phase таймминг. Вы можете поставить число фаз(ы), и
        можете нажать на кнопку пробел несколько раз.
    </li>
    <li><b>Вставка клавиатурой</b> - если хотите внешний таймер как stackmat, вы можете вставить время мануально.</li>
    <li><b>OK/+2/DNF</b> - если эта функция включена, появится подтверждающий диалог. Вы должны выбрать сборку
        (финальное положение) если OK, +2 или DNF. Обычное время может зависить от времени на рассмотр.
    </li>
    <li><b>Аккуратность</b> - аккуратность таймера 0.001с или 1 милисекунда, и может быть показано до 0.01с.</li>
    <li><b>Формат времени</b> - Вы можете поставить формат времени чтобы выключить/включить 'минуты' или 'часы', как:
        hh:mm:ss.XX(X) или mm:ss.XX(X)".
    </li>
    <li><b>Обновление таймера</b> - По каким то причинам, обновление таймера можно поставить на: нет, секунды или
        реальное время.
    </li>
...
<h3>Скрамбл</h3>
<ul>
    <li><b>WCA Оффицальный Скрамблер</b> - csTimer поддерживает всех официальных скрамблеров wca, как: случайная позиция
        скрамблер 2x2x2, 3x3x3, пирамидка, скваер, clock. Случайные движения скрамблер 4x4x4, 5x5x5, 6x6x6, 7x7x7,
        мегаминкс.
    </li>
    <li><b>CFOP Тренировка</b> - Для метода CFOP, специальный скрамблы поддержаные csTimer: скрамбл последнего слоя,
        последний слой + один слот, последний слой + 4 слота.
    </li>
    <li><b>Другие Методы 3x3x3</b> - Чтобы улучшить CFOP, специальные скрамблы поддержаные csTimer: ZBLL, углы/ребра
        последнего слоя, RUL генератор.
    </li>
    <li><b>Roux Тренировка</b> - Для метода Roux, специальные скрамблы поддержаные csTimer: последние шесть ребер, l10p.
    </li>
    <li><b>Тренировка Больших Кубов</b> - Для больших кубов, специальные скрамблы поддержаные csTimer: скрамбл ребер
        4x4x4, 5x5x5, 6x6x6, 7x7x7.
    </li>
    <li><b>3x3x3 BLD Тренировка</b> - Для 3x3x3 bld, специальные скрамблы поддержаные СsTimer: только ребра/углы
        заскрамблены.
    </li>
...
<ul>
    ...
    <li><b>Динамический ao5</b> - После больше 5 сборок, вы можете посмотреть ваш average of 5 на колонке 'ao5' и
        получить деталь нажимая на клетку.
    </li>
    <li><b>Динамический ao12</b> - После больше 12 сборок, вы можете посмотреть ваш average of 12 на колонке 'ao12' и
        получить деталь нажимая на клетку.
    </li>
    <li><b>Детали статистики</b> - Нажмите на клетку которая содержит average сессии, и вы получите детали текущей
        сессии.
    </li>
    <li><b>добавить комментарии</b> - Нажмите на клетку которая содержит время сборки, и вы сможете поставить OK/+2/DNF
        или комментарии.
    </li>
    <li><b>удалить время/сессию</b> - Кликните на индекс прежде времени, И вы сможете удалить все время в ряд. Или
        кликните на кнопку 'X' чтобы удалить все время в текущей сессии.
    </li>
</ul>
...
<ul>
    <table class="table" style="display: inline-block;">
        ...
        <tr>
            <th>Alt + 1</th>
            <td>Тип скрамбла Скваер.</td>
        </tr>
        <tr>
            <th>Alt + 2 ~ 7</th>
            <td>Тип скрамбла 2x2x2~7x7x7.</td>
        </tr>
        <tr>
            <th>Alt + p/m/c/s</th>
            <td>Тип скрамбла пира/мегаминкс/clock/скьюб.</td>
        </tr>
        <tr>
            <th>Alt + i</th>
            <td>Выбрать тип скрамбла.</td>
        </tr>
        <tr>
            <th>Alt + d</th>
            <td>Удалить все время в текущей сессии.</td>
        </tr>
        <tr>
            <th>Alt + z</th>
            <td>Удалить последнее время.</td>
        </tr>
        <tr>
            <th>Alt + up/down</th>
            <td>К следующей/последней сессии.</td>
        </tr>
        <tr>
            <th>Alt + left/rightt</th>
            <td>Показать последний/следующий скрамбл.</td>
        </tr>
        <tr>
            <th>Ctrl + 1/2/3</th>
            <td>Последнее время OK/+2/DNF</td>
        </tr>
    </table>
    <table class="table" id="vrckey" style="display: inline-block;">
        <tr>
            <th colspan=10>Карта Кнопок Виртуального Куба</th>
        </tr>
        <tr>
            <td>1<br><br></td>
            <td>2<br><br></td>
...
<h2>Ссылки</h2>
<ul>
    <li><a class="click" href="http://cubingchina.com/">Кубинг Китай, оффициальный китайский спидкубинговый сайт.</a>
    </li>
...
<div class="donate" style="line-height:1.5em;">
    ...
    <p>Вы можете пожертвовать через PayPal используя кнопку ниже или <a href="https://www.paypal.me/cs0x7f"
