...
<ul>
<li><strong data="opt_ahide">시간 측정 중 모든 창 숨기기</strong>. Hide logo and all panels when timing.</li>
...
<li><strong data="opt_timeFormat">시간 표시 형식</strong>. Time format to display.</li>
...
<li><strong data="opt_useKSC">키보드 단축키 사용</strong>. Use keyboard shortcut to switch scramble type, generate next scramble, switch between sessions, etc.</li>
...
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">섞기 생성기</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_stats">통계 정보</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">시간 분포</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">시간 추이</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">섞기 그림</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Roux S1 도우미</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; EOLine 도우미</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; 십자/Xcross 도우미</strong>. TO_BE_FILLED</li>
