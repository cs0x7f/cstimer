...
<li><strong data="opt_giiAED">Detecção de erro de hardware automática</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">Gerador de Embaralhamentos</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Confirmar tempo</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">estatísticas de sessão cruzada</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Estatíticas</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Distribuição dos tempos</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Gráfico dos tempos</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">desenhar o embaralhamento</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; resolver o Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; resolver a EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; resolver a cruz</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_mtrnm">Metrônomo</strong>. TO_BE_FILLED</li>
