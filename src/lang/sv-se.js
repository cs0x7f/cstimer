...
var IMPORT_FINAL_CONFIRM = 'Det här kommer att skriva över all lokal data! Bekräfta att importera data?';
...
var PROPERTY_UIDESIGN_STR = 'Normal|Materialdesign|Normal m/u skuggor';
...
var PROPERTY_VRCMPS = 'Ingen|CFOP|CF+OP|CFFFFOP|CF4O2P2|Roux';
...
var scrdata = [
	...
	['2x2x2', [
		["WCA", "222so", 0],
		['optimalt slumpmässigt tillstånd', "222o", 0],
		['3-gen', "2223", 25],
		['EG', "222eg", 0],
		['EG0', "222eg0", 0],
		['EG1', "222eg1", 0],
	...
	['Pyraminx', [
		["WCA", "pyrso", 10],
		['optimal slumpmässigt tillstånd', "pyro", 0],
		['slumpmässiga drag', "pyrm", 25]
	]],
	['Skewb', [
		["WCA", "skbso", 0],
		['U L R B', "skb", 25]
	...
	['Gear Cube', [
		...
		['optimalt slumpmässigt tillstånd', "gearo", 0],
		['3-gen', "gear", 10]
	]],
	['Cmetrick', [
		[' ', "cm3", 25]
	...
	['Megaminx subsets', [
		...
		['sista f2l paret + sista lagret', "mlsll", 20]
	]],
	['Relays', [
...
var STATS_CURROUND = 'Nuvarande runda statistik';
...
var STATS_SSMGR_OPS = 'Döpa|Skapa|Dela|Sammanfoga|Radera';
