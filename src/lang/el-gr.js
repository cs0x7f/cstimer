...
var PROPERTY_USEINS_STR = 'παντα|εκτως BLD|ποτε';
var PROPERTY_VOICEINS = 'ηχητική ειδοποίηση για επιθεώρηση του WCA';
var PROPERTY_VOICEINS_STR = 'τιποτα|αρσενικη φωνη|θυλικη φωνη';
...
var PROPERTY_WNDSCR = 'Στυλ εμφάνισης πίνακα ανακατέματος';
var PROPERTY_WNDSTAT = 'Στυλ εμφάνισης πίνακα στατιστικών';
...
var EXPORT_ERROR = 'Προεκυψαν σφαλματα';
var EXPORT_NODATA = 'Δεν βρέθηκαν δεδομένα για το λογαριασμό σας';
var EXPORT_UPLOADED = 'Το αρχείο μεταφορτώθηκε με επιτυχία';
