...
var TOOLS_SYNCSEED_HELP = 'If enabled, the scramble will only depend on the seed and scramble settings. Generally speaking, if two players share a seed, they will obtain the same scrambles.';
