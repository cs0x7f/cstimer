...
<p>csTimer is designed for speedsolving cuber. It supports scrambles of many types of puzzles include <b>all the WCA's
        ...
        timing</b> and several functions supported by other similar software such as: 15s' inspection defined by WCA,
    etc.</p>
...
<ul>
    ...
    <li><b>Multi-phase timing</b> - the timer supports multi-phase timing. You may set the number of phase(s), and might
        press space key several times.
    </li>
