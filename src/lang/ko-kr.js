...
var PROPERTY_COLOR_STR = '무작위로|봄볕|바나나|악마성|수묵화|눈길|달빛|직접 설정|가져오기/내보내기...';
...
var STATS_STRING = '최고|현재|최저|이 통계는 %Y년 %M월 %D일 csTimer에서 자동으로 생성되었습니다.|완성/전체: %d|단일|%mk회 평균|%mk회 절단평균|전체 절단평균: %v{ (σ = %sgm)}|전체 평균: %v|상세 목록:|solving from %s to %e|Totally spent: %d';
