...
var PROPERTY_SCRCLK = 'Acción al tocar mezcla';
var PROPERTY_SCRCLK_STR = 'Nada|Copiar|Next mezcla';
var PROPERTY_WNDSCR = 'Estilo de la visualización del panel del mezcla';
...
var EXPORT_INVID = '¡Solo se permiten letras o números!';
...
var EXPORT_ONLYOPT = 'Exportar/Importar solo los ajustes';
var EXPORT_ACCOUNT = 'Exportar cuentas';
var EXPORT_LOGINGGL = 'Iniciar sesión con Google';
var EXPORT_LOGINWCA = 'Iniciar sesión con WCA';
var EXPORT_LOGOUTCFM = '¿Quieres salir?';
...
var TOOLS_SYNCSEED = 'Mezcla común';
...
var TOOLS_SYNCSEED_DISABLE = '¿Desabilitar semilla actual?';
...
var OLCOMP_ABORT = '¿Abortar competencia y mostrar resultados?';
...
var PROPERTY_ENTERING_STR = 'teclado|manualmente|stackmat|MoYuTimer|virtual|Bluetooth|qCube';
...
var PROPERTY_UIDESIGN = 'El diseño de interfaz es:';
...
var STATS_STRING = 'Mejor|Actual|Peor|Generado por csTimer el %Y-%M-%D|resoluciones/total: %d|Single|Media de %mk|Avg de %mk|Average: %v{ (σ = %sgm)}|Media: %v|Lista de tiempos:|solving from %s to %e|Totally spent: %d';
