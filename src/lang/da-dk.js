...
var TOOLS_SYNCSEED_HELP = 'Hvis aktiveret, vil blanding kun afhænge af frø og indstillinger for blandning. Generelt hvis to spillere deler et frø, vil de få samme blanding(er).';
...
var PROPERTY_ENTERING_STR = 'timer|skrive|stackmat|MoYuTimer|virtuel|Bluetooth|qCube|GAN Smart Timer';
...
var scrdata = [
	...
	['3x3x3', [
		...
		['sidste lag', "ll", 0],
		['zb sidste lag', "zbll", 0],
		['hjørner af sidste lag', "cll", 0],
		['kanter af sidste lag', "ell", 0],
		['sidste seks kanter', "lse", 0],
		['sidste seks kanter&ltM,U&gt', "lsemu", 0],
		['Roux L10P', "cmll", 0],
		['Krydset løst', "f2l", 0],
	...
	['Andet', [
		['FTO (Side Rotér Oktahedron)', "fto", 25]
	]],
	['===SPECIEL===', [
		['--', "blank", 0]
	]],
