<h1>إصدار csTimer <?php echo $version;?> - التكعيب السريع الإحترافي/التدريب مؤقت</h1>
<?php include('lang.php') ?>
<h2>مقدمة</h2>
<p>هذا البرنامج هو برنامج توقيت احترافي صمم للمحترفين في حل مكعب روبيك. و هو يشمل:</p>
<ul>
<li>كمية من خوارزميات الخربطة , جميع احداث(WCA) الرسمية ,  انواع متعددة من الالغاز المختلفة , خوارزميات خربطة تدريبية , لبعض الخطوات المحددة (مثل: F2L, OLL , PLL , ZBLL ) و تستطيع اختيار الحالات , الخ.</li>
<li>الكثير من وظائف الإحصاءات، يدعم <strong>توقيت التقسيم الزمني</strong>؛ <strong>أي عدد من الجلسات</strong>، تقسيم / دمج الجلسة ، إلخ.</li>
<li>أصناف الحل، مثل <strong>cross، Xcross، وجوه 2x2x2، وجوه Skewb ، شكل SQ1</strong>، لتعلم أو تدريب هذه الخطوات الفرعية.</li>
<li>أدوات مساعدة أخرى، مثل صورة التسلسل، والتنبيه إلى الفحص لمدة 8 ثوان (الصوت)، و مِسْرَع ومولّد الدفعات المتشعبة، وما إلى ذلك.</li>
<li>وظيفة النسخ الاحتياطي، لتجنب فقد البيانات، يمكنك نسخ الحلول الخاصة بك إلى الملفات المحلية، خادم csTimer أو تخزين جوجل.</li>
</ul>
<p>csTimer يدعم معظم متصفحات الديسكتوب الحديثة، على الهاتف المحمول والكمبيوتر اللوحي، يمكنك إضافة csTimer إلى شاشتك الرئيسية، وسوف يعمل كتطبيق أصيل.</p>
<p>csTimer يستفيد من ذاكرة التخزين المؤقت للمتصفح، التي تستهلك حركة المرور فقط عند فتحها لأول مرة. بعد ذلك، csTimer قادر على العمل دون اتصال بالشبكة (باستثناء الوظائف مثل النسخ الاحتياطي)</p>
<h3>Copyright</h3>
<p>csTimer هو برنامج مفتوح المصدر يتبع GPLv3. إذا كان لديك أي اقتراحات أو تعليقات على csTimer، يرجى إرسالها <a class="click" href="https://github.com/cs0x7f/cstimer/issues" title="">هنا</a></p>
<p>كتابة: <a href="mailto:cs0x7f@gmail.com">شوانغ تشين (cs0x7f@gmail.com)</a></p>
<p>واجهة المستخدم مصممة بواسطة: <a href="mailto:liebe7@126.com">Yue Zhang (liebe7@126.com)</a></p>
<h2>الوظائف الأساسية</h2>
<ul>
<li><strong>كيفية بدء التوقيت</strong> - اضغط مع الاستمرار على مفتاح space (أو لكل من مفاتيح Ctrl اليسرى واليمنية, أو لمس الشاشة على أجهزة الجوال) وانتظر حتى يتم تشغيل المؤقت باللون الأخضر، سيبدأ المؤقت التوقيت بمجرد تحرير زر space، اضغط على أي مفتاح لإيقاف التوقيت وسيكون وقت الحل مسجلا.</li>
<li><strong>وصف واجهة المستخدم</strong> - هناك 6 أزرار بالقرب من شعار csTimer: الخيار، التصدير، تعقيد المكعب ، قائمة الأوقات ، التبرع، الأدوات، انقر فوق <strong>تصفح</strong>، <strong>قائمة مرات</strong>، <strong>أداة</strong> لفتح لوحة الوظائف المقابلة.</li>
<li><strong>لوحة تعقيد المكعب</strong> - في لوحة التفكيك، يمكنك تحديد نوع التعقيد، تعيين طول التعقيد وتصنيف الحالة (إذا كان متوفرًا)، مراجعة التسلسل السابق، إنشاء التسلسل التالي.</li>
<li><strong>قائمة الأوقات اللوحة</strong> - في قائمة الأوقات اللوحة، يمكنك فتح مدير الجلسة بالنقر فوق "الدورة"، حدد / إضافة/حذف الجلسات، جلسة فارغة من قبل المحدد والزر المجاور له، ثم يمكنك عرض الواحد/المتوسط الحالي، وأفضل واحد/متوسط، وقائمة الوقت الكاملة.</li>
<li><strong>لوحة الأدوات</strong> - في لوحة الأدوات، يمكنك تحديد وظائف مساعدة محددة، بما في ذلك صورة التسلسل، مولدات التسلسل، الحلول، أنواع أخرى من الإحصاءات، إلخ.</li>
</ul>
<h2>الاختصارات</h2>
<table class="table" style="display: inline-block;">
<tr><th>المفتاح</th><td>الاستعمال</td></tr>
<tr><th>ALT+1</th><td>تغير طريقة الخربطة الى Square-1</td></tr>
<tr><th>Alt + 2 ~ 7</th><td>تغير طريقة الخربطة الى 2x2x2 ~ 7x7x7</td></tr>
<tr><th>Alt + p/m/c/s</th><td>تغير طريقة الخريطة الى pyra/megaminx/clock/skewb</td></tr>
<tr><th>Alt + i</th><td>ادخال طريقة الخربطة</td></tr>
<tr><th>Alt + d</th><td>يمسح كل الاوقات التي سجلت في الموسم الحالي</td></tr>
<tr><th>Alt + z</th><td>يمسح اخر وقت سجل</td></tr>
<tr><th>Alt + فوق\تحت</th><td>الى الجلسة التالي\القبل</td></tr>
<tr><th>Alt + يمين\يسار</th><td>تغير الى الخربطة التالية\القبلية</td></tr>
<tr><th>Ctrl + 1/2/3</th><td>الموئقت الاخير جيد\+2\DNF</td></tr>
</table>
</table>
<table class="table" id="vrckey" style="display: inline-block;">
<tr><th colspan=10>خريطة مفتاح المكعب الظاهري</th></tr><tr>
...
<ul>
<li><strong data="opt_ahide">إخفاء كل العناصر عند التوقيت</strong>. Hide logo and all panels when timing.</li>
<li><strong data="opt_useMilli">استخدام جزء من ثانية</strong>. Display the millisecond digit, no matter whether it is checked, the internal timing accuracy of csTimer is 1 millisecond.</li>
<li><strong data="opt_timeFormat">صيغة الوقت</strong>. Time format to display.</li>
...
<li><strong data="opt_zoom">تكبير</strong>. You can adjust sizes of all elements by this option.</li>
<li><strong data="opt_font">إختار طقم حروف المؤقت</strong>. Font of the main timer.</li>
...
<li><strong data="opt_view">شكل واجهه المستخدم</strong>. Switch between desktop and mobile views.</li>
<li><strong data="opt_wndScr">أسلوب عرض لوحة الخلط</strong>. Make scramble panel embedded into background.</li>
<li><strong data="opt_wndStat">أسلوب عرض لوحة الإحصاء</strong>. Make list times panel embedded into background.</li>
<li><strong data="opt_wndTool">اسلوب عرض لوحة الادوات</strong>. Make tool panel embedded into background.</li>
...
<li><strong data="opt_timerSize">حجم المؤقت</strong>. Set the size of main timer.</li>
<li><strong data="opt_smallADP">استخدام خط صغير بعد النقطة العشرية</strong>. Use a smaller font size after the digital point in main timer.</li>
<li><strong data="opt_useMouse">استخدام مؤقت الماوس</strong>. Use mouse to start timer, keyboard-trigger will also be available.</li>
<li><strong data="opt_useIns">استخدام فحص WCA</strong>. Enable WCA inspection procedure, which is a 15-second countdown, auto +2/DNF penalty will also be enabled if you inspecting more than 15 seconds.</li>
<li><strong data="opt_voiceIns">تنبيه صوتي مثل في مسابقات WCA</strong>. Alert at 8s/12s of inspection, to simulate the alert from judge in WCA competitions.</li>
<li><strong data="opt_voiceVol">Voice volume</strong>. Voice level of the alert above.</li>
<li><strong data="opt_input">دخول الأوقات من خلال</strong>. csTimer is able to add solves by several ways, it supports manually input, automatically record from a stackmat timer, connect to a bluetooth smart cube or play virtual Rubik's cube, besides keyboard timing.</li>
...
<li><strong data="opt_timeU">تحديث المؤقت هو</strong>. How timer is updated when timing.</li>
<li><strong data="opt_preTime">وقت إبقاء زر Space لأسفل (ثانية/ثوان)</strong>. How long the space bar should be held before the timer turns green.</li>
<li><strong data="opt_phases">مراحل متعددة</strong>. Number of phases, press any key to mark a split point when timing.</li>
...
<li><strong data="opt_scrSize">حجم الخلط</strong>. Size of the scramble text.</li>
...
<li><strong data="opt_scrMono">خلط احادي الحجم</strong>. Use monospaced font for scramble text.</li>
<li><strong data="opt_scrLim">الحد من حجم منطقة الخلط</strong>. When the scramble area is too high, a scroll bar will occur to avoid the raising of the scramble panel.</li>
<li><strong data="opt_scrAlign">محاذاة منطقة الخلط</strong>. Alignment of the whole scramble area, include scramble type selector.</li>
...
<li><strong data="opt_scrFast">استخدام الخلط السريع لـمكعب 4x4x4 (غير رسمي)</strong>. WCA official 4x4x4 scramble requires huge computation resources, select this option to use a random-move scramble for 4x4x4 instead.</li>
<li><strong data="opt_scrKeyM">تسمية مفتاح الحركة (الحركات) في الخلط</strong>. Mark a key move in the scramble, e.g. the move that take the state away from square shape in SQ1 scrambles.</li>
...
<li><strong data="opt_solSpl">عرض الحل تدريجياً</strong>. If selected, only the length of a solution from a solver is displayed, and you can view the solution one move by one move, otherwise, the whole solution is displayed.</li>
<li><strong data="opt_imgSize">حجم صورة البعثرة</strong>. Set the size of scramble image.</li>
<li><strong data="opt_NTools">عدد الأدوات</strong>. csTimer is able to show up to 4 tools simultaneously.</li>
<li><strong data="opt_useKSC">إستخدم الإختصارات</strong>. Use keyboard shortcut to switch scramble type, generate next scramble, switch between sessions, etc.</li>
<li><strong data="opt_vrcSpeed">سرعة الدوران (دورة كل ثانية)</strong>. Base turn speed of the virtual Rubik's cube, the turn will be speed up if there are multiple moves to turn.</li>
<li><strong data="opt_vrcMP">مراحل متعددة</strong>. Automatic multi-phase split for virtual Rubik's cube and bluetooth cube.</li>
<li><strong data="opt_giiVRC">إظهار مكعب البلوتوث الإفتراضي</strong>. Show a virtual Rubik's cube in the main timer when connecting to a bluetooth cube.</li>
...
<li><strong data="tool_cfm">تأكيد الوقت</strong>. Tool to view current solves with its comment, scramble, solving date and reconstruction if available, which is also the dialog when you click on a solve.</li>
<li><strong data="tool_hugestats">احصاء جلسة اتمام الزائد</strong>. You are able to do cross-session statistics with this tool.</li>
<li><strong data="tool_stats">الإحصائيات</strong>. Statistic table similar with the table in the list times panel.</li>
<li><strong data="tool_distribution">توزيع الوقت</strong>. Time distribution and stability analysis, &lt;X Y/Z means there are totally Y solves less than X seconds, and all of the latest Z solves are less than X seconds in the session.</li>
<li><strong data="tool_trend">اتجاه الوقت</strong>. Shows a trend curve of all solves in current session.</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. Count number of solves each day/week/month/year.</li>
<li><strong data="tool_image">رسم الخلط </strong>. Scramble image to verify a correct scramble, all WCA puzzles are supported.</li>
<li><strong data="tool_roux1">Solvers &gt; روكسS1</strong>. Roux 1st step solver, which solves a 1x2x3 block.</li>
<li><strong data="tool_eoline">Solvers &gt; خط الEO</strong>. EO line solver, which solves orientations of all 12 edges, and positions of DF and DB edges.</li>
<li><strong data="tool_cross">Solvers &gt; الزائد</strong>. Cross solver, which solve DF, DL, DR, DB edges.</li>
...
<li><strong data="tool_giikerutil">مكعب البلوتوث</strong>. Auxiliary tool for bluetooth cube, which is able to show current state, battery power, real-time reconstruction etc.</li>
<li><strong data="tool_if">InsertionFinder</strong>. Insertion finder, which is for FMC.</li>
<li><strong data="tool_mtrnm">إيقاع</strong>. Metronome, besides beeping at specific frequency, you make it beep at specific time after starting solve as well.</li>
...
<p>شكرا لك على إراداتك لدعم csTimer! سيتم استخدام تبرعك لدعم تكاليف التطوير والصيانة.</p>
<p>إذا كنت ترغب في تقديم تبرع لنا من خلال PayPal ، يرجى النقر على الزر أدناه أو من خلال <a class="click" href="https://www.paypal.me/cs0x7f" title="">PayPal.me</a>.</p>
...
<p>يمكنك أيضا تمويلنا بواسطة Alipay، أو مسح الرمز الثنائي الأبعاد التالي أو الرجاء الدفع إلى الحساب: cs0x7f@gmail.com</p>
