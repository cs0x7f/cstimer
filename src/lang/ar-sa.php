...
<li><strong data="opt_color">حدد سمة اللون</strong>. Select color schemes of csTimer. Click csTimer's logo to show more color schemes.</li>
...
<li><strong data="opt_useKSC">إستخدم الإختصارات</strong>. Use keyboard shortcut to switch scramble type, generate next scramble, switch between sessions. Click csTimer's logo to show details.</li>
