...
var PROPERTY_ENTERING_STR = '초시계|직접 입력|스택매트|모위(MoYu)|가상 큐브|Giiker';
...
var PROPERTY_COLOR_STR = '무작위로|봄볕|바나나|악마성|수묵화|눈길|달빛|직접 설정|내보내기...|가져오기...';
...
var PROPERTY_VRCMPS = '없음|CFOP|CF+OP|CFFFFOP|Roux';
...
var scrdata = [
	...
	['3x3x3 부분집합', [
		['2원 생성자: R,U', "2gen", 25],
		['2원 생성자: L,U', "2genl", 25],
		['루(Roux) 생성자: M,U', "roux", 25],
		['3원 생성자: F,R,U', "3gen_F", 25],
		['3원 생성자: R,U,L', "3gen_L", 25],
		['3원 생성자: R,r,U', "RrU", 25],
		['반 바퀴 회전만', "half", 25],
...
var STATS_CFM_DELSS = '이 모둠을 삭제할까요?';
...
var STATS_SESSION_NAME = '모둠 이름';
var STATS_STRING = '최고|현재|최저|이 통계는 %Y년 %M월 %D일 csTimer에서 자동으로 생성되었습니다.|완성/전체: %d|단일|%mk회 평균|%mk회 절단평균|전체 절단평균: %v{ (σ = %sgm)}|전체 평균: %v|상세 목록:|solving from %s to %e';
