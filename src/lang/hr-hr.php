...
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">Generator scramble-ova</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Potvrdi vrijeme</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">cross-session stats</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Statistika</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">distribucija vremena</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">trend vremena</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">prikaži scramble</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; složi Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; složi EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; složi križ</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_giikerutil">Giiker Kocka</strong>. TO_BE_FILLED</li>
