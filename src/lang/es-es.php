...
<li><strong data="opt_giiAED">Detección de errores de hardware automática</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">ScrambleGenerator</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Confirmar tiempo </strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">estadísticas de la sesión de cruz</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Estadísticas</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Distribución de tiempos</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Tendencia del tiempo</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">Imagen de la mezcla</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Resolver Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; Resolver EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; Resolver cruz</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_mtrnm">Metrónomo</strong>. TO_BE_FILLED</li>
