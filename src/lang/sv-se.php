...
<li><strong data="opt_giiAED">Automatisk identifiering av hårdvarafel</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">Blandningsgenerator</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Bekräfta tid</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">kors-session statistik</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Statistik</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">tidsfördelning</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">tidsutveckling</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">rita blandning</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; lös Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; lös EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; lös kors</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_onlinecomp">Onlinetävling</strong>. TO_BE_FILLED</li>
