...
<tr><th colspan=10>Virtual Cube tangenter</th></tr><tr>
...
<li><strong data="tool_if">InsertionFinder</strong>. Insertion finder, för FMC.</li>
<li><strong data="tool_mtrnm">Metronom</strong>. Metronom, förutom att pipa vid specifik frekvens, gör du att den piper vid en specifik tid efter att du har börjat lösa.</li>
<li><strong data="tool_onlinecomp">Onlinetävling</strong>. Onlinetävling, så att du kan logga in med WCA-konto och tävla med alla speedsolvers runt om i världen med samma blandningar.</li>
<li><strong data="tool_stackmatutil">stackmat</strong>. Hjälpmedel för Stackmat, som kan se signalens status, effekt och ljudnivå, etc.</li>
</ul>
<h2>Länkar</h2>
<ul>
