...
var PROPERTY_ENTERING_STR = 'таймер|писать|stackmat|виртуально';
...
var SCRAMBLE_NOOBST = [
	['повернуть нижнюю грань', 'turn the bottom face'],
	['повернуть левую грань', 'turn the left face'],
	['повернуть заднюю грань', 'turn the back face']
];
