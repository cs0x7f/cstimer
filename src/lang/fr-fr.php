...
<li><strong data="opt_giiAED">Détection automatique d'erreur hardware</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">Générateur de mélange</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Confirmer le temps</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">Stats sur plusieurs sessions</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Statistiques</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Répartition des temps</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Tendance des temps</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">Image du mélange</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Résoudre 1er bloc Roux</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; Résoudre l'EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; Résoudre la croix</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_mtrnm">Métronome</strong>. TO_BE_FILLED</li>
<li><strong data="tool_onlinecomp">Compétition en ligne</strong>. TO_BE_FILLED</li>
