...
var PROPERTY_USEINS = 'WCA निरीक्षण का उपयोग करें';
var PROPERTY_USEINS_STR = 'हमेशा (नीचे)|हमेशा (ऊपर)|BLD को छोड़कर (नीचे)|BLD को छोड़कर (ऊपर)|कभी नहीं';
var PROPERTY_SHOWINS = 'निरीक्षण सक्षम होने पर एक आइकन दिखाएं';
var PROPERTY_VOICEINS = 'WCA निरिक्षण के लिए आवाज़ की चेतावनी';
var PROPERTY_VOICEINS_STR = 'कोई नहीं|पुरुष आवाज़|महिला आवाज़';
var PROPERTY_VOICEVOL = 'Voice volume';
var PROPERTY_PHASES = 'एकाधिक-स्थिति';
var PROPERTY_TIMERSIZE = 'टाइमर का विस्तार';
var PROPERTY_USEMILLI = 'मिलीसेकंड का उपयोग करें';
var PROPERTY_SMALLADP = 'दशमलव बिंदु के बाद छोटे फ़ॉन्ट का उपयोग करें';
var PROPERTY_SCRSIZE = 'फेरबदल का विस्तार';
var PROPERTY_SCRMONO = 'मोनोस्पेस करी हुई फेरबदल';
var PROPERTY_SCRLIM = 'फेरबदल क्षेत्र की ऊंचाई सीमित करें';
var PROPERTY_SCRALIGN = 'फेरबदल क्षेत्र का संरेखण';
...
var PROPERTY_WNDSCR = 'फेरबदल पैनल प्रदर्शन शैली';
var PROPERTY_WNDSTAT = 'सांख्यिकी पैनल प्रदर्शन शैली';
var PROPERTY_WNDTOOL = 'उपकरण पैनल प्रदर्शन शैली';
var PROPERTY_WND_STR = 'सामान्य|सपाट';
var EXPORT_DATAEXPORT = 'आंकड़ों का आयात/निर्यात';
var EXPORT_TOFILE = 'फ़ाइल में निर्यात करें';
var EXPORT_FROMFILE = 'फ़ाइल से आयात करें';
var EXPORT_TOSERV = 'सर्वर पर निर्यात करें';
var EXPORT_FROMSERV = 'सर्वर से आयात करें';
var EXPORT_FROMOTHER = 'अन्य टाइमर से सत्र आयात करें';
var EXPORT_USERID = 'कृपया अपने खाते का नाम लिखें (केवल अक्षर या संख्या)';
var EXPORT_INVID = 'केवल अक्षर या संख्या की अनुमति है!';
var EXPORT_ERROR = 'कुछ त्रुटि हुई...';
var EXPORT_NODATA = 'आपके खाते के लिए कोई डेटा नहीं मिला';
var EXPORT_UPLOADED = 'अपलोड सफल';
...
var BUTTON_SCRAMBLE = 'स्क्रैम्बल';
var BUTTON_TOOLS = 'उपकरण';
var IMAGE_UNAVAILABLE = 'इस फेरबदल प्रकार के लिए अनुपलब्ध है';
var TOOLS_SELECTFUNC = 'कार्य';
var TOOLS_CROSS = 'क्रॉस';
var TOOLS_EOLINE = 'इ.ओ. लाइन';
var TOOLS_ROUX1 = 'Roux S1';
var TOOLS_222FACE = '2x2x2 face';
var TOOLS_GIIKER = 'ब्लूटूथ क्यूब';
var TOOLS_IMAGE = 'फेरबदल का चित्र बनाएं';
var TOOLS_STATS = 'सांख्यिकी';
var TOOLS_HUGESTATS = 'विभिन्न सत्रों के आँकड़े';
var TOOLS_DISTRIBUTION = 'समयों का वितरण';
var TOOLS_TREND = 'समय की प्रवृत्ति';
var TOOLS_METRONOME = 'ताल-मापनी';
var TOOLS_RECONS = 'पुनर्निर्माण';
var TOOLS_RECONS_NODATA = 'No solution found.';
var TOOLS_RECONS_TITLE = 'insp|exec|turn|tps';
var TOOLS_TRAINSTAT = 'प्रशिक्षण सांख्यिकी';
var TOOLS_BLDHELPER = 'BLD सहायक';
var TOOLS_CFMTIME = 'समय की पुष्टि';
...
var PROPERTY_IMGSIZE = 'फेरबदल की छवि का आकार';
var PROPERTY_IMGREP = 'Show virtual cube animation when clicking scramble image';
var TIMER_INSPECT = 'निरीक्षण करें';
var TIMER_SOLVE = 'हल करें';
var PROPERTY_USEMOUSE = 'माउस टाइमर का उपयोग करें';
var PROPERTY_TIMEU = 'टाइमर अद्यतन है';
var PROPERTY_TIMEU_STR = 'अद्यतन|0.1 सेकंड|सेकंड|निरीक्षण|कोई नहीं';
var PROPERTY_PRETIME = 'स्पेसबार को नीचे रखने का समय (सेकंड)';
var PROPERTY_ENTERING = 'समयों का अभिलेखन किसके साथ करें?';
var PROPERTY_ENTERING_STR = 'टाइमर|टाइपिंग|स्टैकमैट|मोयू टाइमर|वर्चुअल|ब्लूटूथ|क्यूक्यूब|गैनटाइमर|अंतिम परत प्रशिक्षण';
var PROPERTY_INTUNIT = 'Unit when entering an integer';
var PROPERTY_INTUNIT_STR = 'second|centisecond|millisecond';
var PROPERTY_COLOR = 'रंग विषयवस्तु का चयन करें';
var PROPERTY_COLORS = 'फ़ॉन्ट का रंग|पृष्ठभूमि का रंग|बोर्ड का रंग|बटन का रंग|लिंक का रंग|लोगो का रंग|लोगो की पृष्ठभूमि का रंग';
var PROPERTY_VIEW = 'इंटरफ़ेस शैली है';
var PROPERTY_VIEW_STR = 'स्वचालित|मोबाइल|डेस्कटॉप';
...
var COLOR_EXPORT = 'कृपया आयात के लिए निम्नलिखित निर्यात किए गए अक्षर सहेजें';
var COLOR_IMPORT = 'कृपया निर्यातित अक्षर लिखें या चिपकाएं';
var COLOR_FAIL = 'डेटा ग़लत है, आयात विफल';
var PROPERTY_FONTCOLOR_STR = 'काला|सफ़ेद';
var PROPERTY_COLOR_STR = 'दस्ती|आयात/निर्यात...|क्रम रहित|स्टाइल१|स्टाइल२|स्टाइल३|काला|सफ़ेद|स्टाइल६|सोलराइज़्ड डार्क|सोलराइज़्ड लाइट';
var PROPERTY_FONT = 'टाइमर का फ़ॉन्ट चुनें';
...
var SCRAMBLE_NEXT = 'अगली';
var SCRAMBLE_SCRAMBLE = ' फेरबदल';
var SCRAMBLE_SCRAMBLING = 'फेरबदल किया जा रहा है';
var SCRAMBLE_LENGTH = 'लंबाई';
var SCRAMBLE_INPUT = 'फेरबदल लिखें या चिपकाएं';
var PROPERTY_VRCSPEED = 'वर्चुअल क्यूब - आधार गति (टीपीएस)';
var PROPERTY_VRCMP = 'एकाधिक-स्थिति';
var PROPERTY_VRCMPS = 'कोई नहीं|CFOP|CF+OP|CFFFFOP|CFFFFOOPP|Roux';
...
var scrdata = [
	...
	['3x3x3', [
		...
		['BLD सहायक', "nocache_333bldspec", 0],
