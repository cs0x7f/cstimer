...
<li><strong data="opt_useKSC">Folosește scurtătura tastaturii</strong>. Use keyboard shortcut to switch scramble type, generate next scramble, switch between sessions, etc.</li>
