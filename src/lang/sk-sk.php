...
<li><strong data="opt_useMilli">používať milisekundy</strong>. Display the millisecond digit, no matter whether it is checked, the internal timing accuracy of csTimer is 1 millisecond.</li>
...
<li><strong data="opt_zoom">Lupa</strong>. You can adjust sizes of all elements by this option.</li>
...
<li><strong data="opt_useIns">Používať WCA inšpekciu</strong>. Enable WCA inspection procedure, which is a 15-second countdown, auto +2/DNF penalty will also be enabled if you inspecting more than 15 seconds.</li>
<li><strong data="opt_voiceIns">Hlas upozornenia na WCA inšpekciu</strong>. Alert at 8s/12s of inspection, to simulate the alert from judge in WCA competitions.</li>
...
<li><strong data="tool_cfm">Potvrdiť čas</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">cross-session stats</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Štatistiky</strong>. TO_BE_FILLED</li>
