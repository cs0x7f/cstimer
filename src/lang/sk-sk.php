...
<li><strong data="tool_cfm">Potvrdiť čas</strong>. Tool to view current solves with its comment, scramble, solving date and reconstruction if available, which is also the dialog when you click on a solve.</li>
<li><strong data="tool_hugestats">cross-session stats</strong>. You are able to do cross-session statistics with this tool.</li>
<li><strong data="tool_stats">Štatistiky</strong>. Statistic table similar with the table in the list times panel.</li>
