...
var EXPORT_CODEPROMPT = 'Enregistrez ce code, ou tapez un code préalablement enregistré pour l\'import.';
...
var TOOLS_SYNCSEED_HELP = 'Si activé, le mélange dépendra uniquement des paramètres de mélange et de "seed". ';
...
var STATS_STRING = 'meilleure|en cours|moins bonne|Généré par csTimer le %Y-%M-%D|résolutions/total: %d|single|moyenne sur %mk|moyenne élaguée sur %mk|Moyenne élaguée: %v{ (σ = %sgm)}|Moyenne: %v|Liste des temps:|résolutions de %s à %e|Temps passé: %d';
