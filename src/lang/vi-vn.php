...
<li><strong data="tool_distribution">Thành tích ( kiểu 2)</strong>. Time distribution and stability analysis, &lt;X Y/Z means there are totally Y solves less than X seconds, and all of the latest Z solves are less than X seconds in the session.</li>
...
<li><strong data="tool_roux1">Solvers &gt; giải Roux S1</strong>. Roux 1st step solver, which solves a 1x2x3 block.</li>
<li><strong data="tool_eoline">Solvers &gt; giải EOLine</strong>. EO line solver, which solves orientations of all 12 edges, and positions of DF and DB edges.</li>
<li><strong data="tool_cross">Solvers &gt; giải cross</strong>. Cross solver, which solve DF, DL, DR, DB edges.</li>
