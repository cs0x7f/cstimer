...
<li><strong data="tool_stats">Thành tích ( kiểu 1)</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Thành tích ( kiểu 2)</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Thành tích ( kiểu 3)</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">vẽ scramble</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; giải Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; giải EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; giải cross</strong>. TO_BE_FILLED</li>
