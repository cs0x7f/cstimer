...
var TOOLS_SYNCSEED_HELP = 'Hvis aktivert, vil blandingen bare være avhengig av hovednøkkelen og blandingsinstillingene. Hvis to spillere deler en hovednøkkel, vil de få samme blanding.';
...
var PROPERTY_ENTERING_STR = 'Tidtaker|Skrive|Stackmat|MoYuTidtaker|virtuell|bluetooth|qCube|GAN Smart Timer';
...
var scrdata = [
	...
	['Super Square-1', [
		['Vri metrisk', "ssq1t", 20]
	]],
	['UFO', [
		['Jaap stil', "ufo", 25]
	]],
	['Andre', [
		['FTO (Side Vridende Oktahedron)', "fto", 25]
	]],
	['===SPESIELLE===', [
		['--', "blank", 0]
	]],
	['3x3x3 undersett', [
		...
		['3-generatorer R,r,U', "RrU", 25],
		['bare halvrotasjoner', "half", 25],
