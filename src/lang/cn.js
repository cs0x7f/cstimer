...
var BUTTON_TOOLS = '工具';
var CROSS_UNAVAILABLE = '不支持此打乱类型的十字求解';
var EOLINE_UNAVAILABLE = '不支持此打乱类型的EOLine求解';
var IMAGE_UNAVAILABLE = '不支持此打乱类型的打乱图案';
...
var PROPERTY_COLOR_STR = '随机切换|春意盎然|金风玉露|血腥玛丽|水墨青华|银装素裹|荷塘月色|自定义';
