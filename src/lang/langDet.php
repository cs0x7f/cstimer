...
if ($lang == "cn") { ?>
    ...
    <meta name="description"
          content="csTimer是迄今为止功能最全面、界面最友好、使用最便捷的在线版网页魔方计时器：提供三阶魔方、N阶魔方、各种异形魔方的打乱；提供多种成绩统计功能；可离线保存成绩的魔方计时器；提供符合WCA官方所有打乱的魔方计时器；提供各类训练功能，如cross，F2L，OPLL，盲拧，高阶对棱功能的魔方计时器等。">
...
<?php } else if ($lang == "tr") { ?>
    <meta name="keywords"
          content="Kronometre, cstimer, rubik küpü kronometresi, internet kronometresi, web kronometresi">
