...
$lang = prefered_language(array("en-us", "ar-sa", "ca-es", "cs-cz", "da-dk", "de-de", "el-gr", "es-es", "fa-ir", "fi-fi", "fr-fr", "he-il", "hi-in", "hr-hr", "hu-hu", "it-it", "ja-jp", "ko-kr", "lv-lv", "nl-nl", "no-no", "pl-pl", "pt-pt", "ro-ro", "ru-ru", "sk-sk", "sr-sp", "sv-se", "tr-tr", "uk-ua", "vi-vn", "zh-cn", "zh-tw"), $req_lang);
...
var LANG_SET = '|en-us|ar-sa|ca-es|cs-cz|da-dk|de-de|el-gr|es-es|fa-ir|fi-fi|fr-fr|he-il|hi-in|hr-hr|hu-hu|it-it|ja-jp|ko-kr|lv-lv|nl-nl|no-no|pl-pl|pt-pt|ro-ro|ru-ru|sk-sk|sr-sp|sv-se|tr-tr|uk-ua|vi-vn|zh-cn|zh-tw';
var LANG_STR = 'English|العربية|Català|Čeština|Dansk|Deutsch|Ελληνικά|Español|فارسی|Suomi|Français|עברית|हिन्दी|Hrvatski|Magyar|Italiano|日本語|한국어|Angļu|Nederlands|Norsk|Polski|Português|Română|Pусский|Slovenčina|Српски|Svenska|Türkçe|Українська|Tiếng Việt|简体中文|繁體中文';
