...
<li><strong data="opt_useMilli">השתמש באלפיות שנייה</strong>. Display the millisecond digit, no matter whether it is checked, the internal timing accuracy of csTimer is 1 millisecond.</li>
...
<li><strong data="opt_scrSize">גודל בלגון</strong>. Size of the scramble text.</li>
...
<li><strong data="tool_cfm">אשר זמן</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">סטטיסטיקות רשימת פלוס</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">סטטיסטיקות</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">חלוקת זמן</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">מגמת זמן</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">בלגון חדש</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; פתור Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; פתור EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; פתור פלוס</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_giikerutil">קוביית Giiker</strong>. TO_BE_FILLED</li>
<li><strong data="tool_if">InsertionFinder</strong>. TO_BE_FILLED</li>
<li><strong data="tool_mtrnm">מטרונום</strong>. TO_BE_FILLED</li>
