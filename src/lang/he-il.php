...
<li><strong data="tool_roux1">Solvers &gt; פתור Roux S1</strong>. Roux 1st step solver, which solves a 1x2x3 block.</li>
<li><strong data="tool_eoline">Solvers &gt; פתור EOLine</strong>. EO line solver, which solves orientations of all 12 edges, and positions of DF and DB edges.</li>
<li><strong data="tool_cross">Solvers &gt; פתור פלוס</strong>. Cross solver, which solve DF, DL, DR, DB edges.</li>
