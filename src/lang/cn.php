<h1>csTimer version 2018.11.05 - 魔方竞速训练专用计时器</h1>
<?php include('lang.php') ?>
<p>csTimer是专门为魔方爱好者精心设计的一款专业计时软件，是迄今为止功能最全面、界面最友好、使用最便捷的在线版网页魔方计时器。它提供各类魔方的打乱公式，WCA规则下的<b>所有官方比赛打乱</b>；它集成了<b>Xcross求解模块和eoline求解模块</b>以方便魔方爱好者学习相关玩法；它提供了丰富的成绩统计功能；它支持<b>分段计时</b>；以及很多同类软件经常提供的功能，包括：WCA规则中的15秒观察，启动前长按空格等。
</p>
...
<h3>打乱功能</h3>
<ul>
    <li><b>WCA规范打乱</b> - csTimer提供所有WCA项目在WCA要求下的打乱，包括：二阶魔方、三阶魔方、金字塔、Square-1、魔表
        这五类魔方的随机状态打乱，四阶魔方、五阶魔方、六阶魔方、七阶魔方、五魔方的随机步数打乱。
    </li>
...
<ul>
    <table class="table" style="display: inline-block;">
        ...
        <tr>
            <th>Alt + 1</th>
            <td>打乱类型切换至 Square-1</td>
        </tr>
        <tr>
            <th>Alt + 2 ~ 7</th>
            <td>打乱类型切换至 二~七阶魔方</td>
        </tr>
        <tr>
            <th>Alt + p/m/c/s</th>
            <td>打乱类型切换至 金字塔/五魔方/魔表/斜转魔方</td>
        </tr>
        <tr>
            <th>Alt + i</th>
            <td>将当前打乱类型切换至 手动输入</td>
        </tr>
        <tr>
            <th>Alt + d</th>
            <td>删除统计功能中本组所有成绩</td>
        ...
        <tr>
            <th>Ctrl + 1/2/3</th>
            <td>将最新成绩的完成状态改为 OK/+2/DNF</td>
        </tr>
    </table>
    <table class="table" id="vrckey" style="display: inline-block;">
        <tr>
            <th colspan=10>虚拟魔方按键表</th>
        </tr>
        <tr>
            <td>1<br><br></td>
            <td>2<br><br></td>
