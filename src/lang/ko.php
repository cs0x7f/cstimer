<h1>csTimer  version <?php echo $version;?> - 큐브 연습용 초시계</h1>
<?php include('lang.php') ?>
<p>csTimer는 큐브 애호가들을 위해 특별히 고안된 시간 측정 소프트웨어로, 가장 포괄적이고 사용하기 쉬운 온라인 초시계입니다. csTimer는 <b>모든 WCA 공식 종목</b>을 비롯해 다양한 트위스티 퍼즐의 섞기를 제공합니다. 또한 초보자가 큐브 맞추기를 보다 수월하게 익힐 수 있도록 <b>Xcross 및 EOLine 도우미</b>를 탑재하였으며, 통계 기능, <b>다단계 측정</b>, (WCA 규정에 따른) 15초 미리보기 등 다양한 편의기능을 갖추고 있습니다.</p>
...
<h3>초시계 기능</h3>
<ul>
 <li><b>시간 측정</b> - 먼저 스페이스바를 눌러 화면의 글자가 초록색으로 바뀔 때까지 기다립니다. 그 다음 손가락을 자판에서 떼면 시간 측정이 시작되고, 퍼즐을 맞춘 뒤 아무 키나 누르면 측정이 종료되고 시간이 기록됩니다.</li>
 <li><b>시동 전 대기</b> - csTimer는 스택매트와 마찬가지로 시동 전 대기 기능을 지원합니다. 따라서 시간을 측정하기 위해서는 스페이스바를 떼기 전에 잠시 동안 기다려야 합니다. 물론 시동을 위한 대기 시간은 설정에서 조절할 수 있습니다.</li>
 ...
 <li><b>벌칙 적용</b> - 이 기능을 허용하면, 시간 측정 후 벌칙 적용을 위한 창이 등장합니다. 이 기능을 허용하지 않으면 (미리보기 시간을 초과하지 않는 이상) 모든 측정 결과가 유효한 것으로 간주됩니다.</li>
 <li><b>표시 정확도</b> - csTimer의 표시 정확도는 최대 0.001초입니다. 설정에서 표시 단위를 0.01초로 변경할 수 있으나, 소프트웨어 내부에 기록되는 측정 단위는 0.001초이므로 실제로 정확도가 감소하거나 하지는 않습니다.</li>
...
<h3>섞기 기능</h3>
<ul>
 <li><b>WCA 규격 섞기</b> - csTimer는 다음의 모든 WCA 규격 섞기를 지원합니다: 2x2x2, 3x3x3, 피라밍크스, 스퀘어-1, 클락의 무작위 상태 섞기 및 4x4x4, 5x5x5, 6x6x6, 7x7x7, 메가밍크스의 무작위 수순 섞기.</li>
...
<h3>통계 기능</h3>
<ul>
 <li><b>모둠 구분</b> - 시간목록 창의 맨 첫 줄은 모둠 선택 칸입니다. 이 칸에서 모둠의 종류를 변경/추가할 수 있으며, 각 모둠의 퍼즐(섞기) 유형을 서로 다르게 지정할 수 있습니다. 모든 측정 결과는 모둠 단위로 기록되며, 각 모둠의 통계는 독립적으로 산출됩니다.</li>
 <li><b>실시간 평균</b> - 현재 모둠의 측정 횟수와 실시간 전체 평균이 시간목록 위에 굵은 글씨로 표시됩니다.</li>
 <li><b>동적 5회평</b> - 측정 횟수가 5회에 도달한 뒤부터 시간목록의 'ao5' 열에 5회 절단평균이 실시간으로 표시되며, 그 중 원하는 값을 눌러 상세 정보를 표시하거나 내보낼 수 있습니다.</li>
 <li><b>동적 12회평</b> - 측정 횟수가 12회에 도달한 뒤부터 시간목록의 'ao12' 열에 12회 절단평균이 실시간으로 표시되며, 그 중 원하는 값을 눌러 상세 정보를 표시하거나 내보낼 수 있습니다.</li>
 ...
 <li><b>시간 삭제/모둠 초기화</b> - 시간이 적혀있는 칸에 화살표를 옮긴 뒤 나타나는 창에서 'X' 단추를 눌러 해당 시간을 삭제하거나, 모둠 선택 칸 옆의 'X' 단추를 눌러 해당 모둠의 시간목록을 초기화할 수 있습니다.</li>
</ul>
<h3>단축키</h3>
<ul>
 <table class="table" style="display: inline-block;">
  <tr><th>단축키</th><td>기능</td></tr>
  <tr><th>Alt + 1</th><td>섞기 유형을 스퀘어-1로 전환합니다.</td></tr>
  <tr><th>Alt + 2 ~ 7</th><td>섞기 유형을 2x2x2~7x7x7로 전환합니다.</td></tr>
  <tr><th>Alt + p/m/c/s</th><td>섞기 유형을 피라/메가밍크스/클락/스큐브로 전환합니다.</td></tr>
  <tr><th>Alt + i</th><td>섞기 유형을 수동 입력으로 전환합니다.</td></tr>
  <tr><th>Alt + d</th><td>현재 모둠의 시간목록을 초기화합니다.</td></tr>
  <tr><th>Alt + z</th><td>현재 모둠에서 가장 마지막에 측정된 시간을 삭제합니다. </td></tr>
  <tr><th>Alt + 위/아래</th><td>이전/다음 모둠으로 전환합니다.</td></tr>
  <tr><th>Alt + 왼쪽/오른쪽</th><td>이전/다음 섞기 공식을 표시합니다.</td></tr>
  <tr><th>Ctrl + 1/2/3</th><td>가장 마지막에 측정된 시간에 'OK/+2/DNF'를 적용합니다.</td></tr>
 </table>
 <table class="table" id="vrckey" style="display: inline-block;">
  <tr><th colspan=10>가상 큐브 키 설정</th></tr><tr>
...
<p>후원을 희망하시는 분들께서는 페이팔(PayPal)을 이용하여 아래의 단추나 <a href="https://www.paypal.me/cs0x7f" class="click"> PayPal.me</a>에서 기부하실 수 있습니다. </p>
