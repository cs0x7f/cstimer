<h1>csTimer  version <?php echo $version;?> - Professionel Speedcubing/Tr&aelig;nings Timer</h1>
...
p&aring; de fleste browsere, f.eks: chrome(anbefalet), firefox, opera, IE7+. Og den virker ogs&aring; p&aring; ipad, iphone og det meste af Android-platformen. </p>
...
<h2>Introduktion</h2>
<ul>
<li><b>Timer</b> - St&oslash;tter wca inspektion, multi-fase timing, indtastning via tastatur, bekr&aelig;ft OK / + 2 / DNF. Akkurathed er 0.001s.</li>
<li><b>Blanding</b> - St&oslash;tter alle wca blandinger. K&aelig;mpe antal uofficielle og tr&aelig;nings blandinger, som f.eks .: kun kant / hj&oslash;rne, sidste lag.</li>
<li><b>Statistikker</b> - Vis gennemsnitligt 5/12 dynamisk. Export statistikker for den aktuelle session inkluderer bedste gennemsnit p&aring; 5/12 osv.</li>
<li><b>Tools</b> - St&oslash;tter l&oslash;sning af krydset, Xcross(udvidet kryds), EOLine. Blandings billede for NxNxN cube.</li>
</ul>
<h2>Detaljer</h2>
csTimer er blevet testet p&aring; Firefox, Chrome og Safari. Og det virker ogs&aring; godt p&aring; ipad (testet af oyyq).
<h3>Timer</h3>
<ul>
 <li><b>Traditionel</b> - Tryk p&aring; 'mellemrum'-tasten, indtil skrifttypens farve skifter gr&oslash;n. Timingen starter, n&aring;r du slipper n&oslash;glen og registrerer opl&oslash;sningstiden, n&aring;r du trykker p&aring; tasten igen.</li>
 <li><b>Presse tid</b> - Samme som stackmat, csTimer underst&oslash;tter presningstid. Du skal holde 'mellemrums'-tasten et stykke tid, f&oslash;r du frigiver det.  </li>
 <li><b>WCA inspektion</b> - csTimer underst&oslash;tter inspektionstiden beskrevet i wca's regulering. Hvis den er aktiveret, vil timeren v&aelig;re ved inspektionstilstand efter at du har startet den.</li>
 <li><b>Multi-fase timing</b> - Timeren underst&oslash;tter multifase timing. Du kan indstille antallet af fase(r), og du kan trykke flere gange p&aring; mellemrumstasten. </li>
 <li><b>Inds&aelig;t med keyboard</b> - Hvis du vil bruge ekstern timer som stackmat, kan du indtaste tid manuelt</li>
 <li><b>OK/+2/DNF</b> - Hvis denne funktion er aktiveret, vises en bekr&aelig;ftelsesdialog. Du skal v&aelig;lge, om l&oslash;sningen (finish tilstand) er OK, +2 eller DNF. Standardv&aelig;rdien kan afh&aelig;nge af inspektionstiden.</li>
 <li><b>Accuracy</b> - n&oslash;jagtigheden af ??timeren er 0,001 eller 1 millisekund, og kan vises til 0,01 s. </li>
 <li><b>Time format</b> - Du kan indstille tidsformatet til at deaktivere / aktivere 'minutter' eller 'timer', f.eks .: hh: mm: ss.XX (X) eller mm: ss.XX (X) ".</li>
 <li><b>Timer update</b> - Af nogle &aring;rsager kan opdatering af timer v&aelig;re indstillet til: ingen, sekunder eller realtid.</li>
 <li><b>Font size</b> - For at tilpasse sk&aelig;rme med forskellige st&oslash;rrelser, kan du indstille typografiens formatst&oslash;rrelse.</li>
 <li><b>Color style</b> - Der er mange farveformater. V&aelig;lg den du kan lide.</li>
</ul>
<h3>Blanding</h3>
<ul>
 <li><b>WCA Officiel Blander</b> - csTimer underst&oslash;tter alle wca's officielle scrambler, s&aring;som: random-state scrambler p&aring; 2x2x2, 3x3x3, pyraminx, square-1, ur. Tilf&aelig;ldig bev&aelig;gelse af 4x4x4, 5x5x5, 6x6x6, 7x7x7, megaminx.</li>
 <li><b>CFOP Tr&aelig;ning</b> - For CFOP-metoden er specielle scrambles underst&oslash;ttet af csTimer: scramble af sidste lag, sidste lag + en slot, sidste lag + 4 slots.</li>
 <li><b>Andre 3x3x3 metoder</b> - Til forbedring af CFOP er specielle scrambles underst&oslash;ttet af csTimer: ZBLL, hj&oslash;rner / kanter af sidste lag, RUL generator..</li>
 <li><b>Roux Tr&aelig;ning</b> - Til Roux-metoden er specielle scrambles underst&oslash;ttet af csTimer: sidste seks kant, l10p.</li>
 <li><b>Stor cube tr&aelig;ning</b> - Til stor terning er specielle scrambles underst&oslash;ttet af csTimer: scramble af kanter af 4x4x4, 5x5x5, 6x6x6, 7x7x7.</li>
 <li><b>3x3x3 BLD Tr&aelig;ning</b> - Til 3x3x3 bld er specielle scrambles underst&oslash;ttet af csTimer: Kun kanter / hj&oslash;rner krypteret.</li>
 <li><b>Andre Puzzles</b> - csTimer underst&oslash;tter ogs&aring; et stort antal puzzles, som ikke er wca's puzzles.</li>
</ul>
<h3>Statistikker</h3>
<ul>
 ...
 <li><b>Dynamisk ga5</b> - Efter at du har l&oslash;st den mere end 5 gange, kan du kontrollere dit gennemsnit p&aring; 5 i 'ga5' kolonnen og f&aring; detaljer ved at klikke p&aring; cellen.</li>
 <li><b>Dynamisk ga12</b> - Efter at du har l&oslash;st den mere end 12 gange, kan du kontrollere dit gennemsnit p&aring; 12 ved 'ga12' kolonnen og f&aring; detaljer ved at klikke p&aring; cellen.</li>
 <li><b>Statistisk detaljer</b> - Klik p&aring; cellen, der indeholder sessionsgennemsnit, du f&aring;r detaljerne i den aktuelle session.</li>
 <li><b>add comments</b> - Klik p&aring; cellen, der indeholder en l&oslash;sningstid, du kan indstille tiden til OK / + 2 / DNF eller kommentarer.</li>
 <li><b>delete time/session</b> - Klik p&aring; indekset f&oslash;r tid, du kan slette tiden i samme r&aelig;kke. Eller klik p&aring; 'X' knappen for at fjerne alle gange i den aktuelle session. </li>
</ul>
...
<ul>
 <table class="table" style="display: inline-block;">
  ...
  <tr><th>Alt + i</th><td>Blanding type til indeks.</td></tr>
  <tr><th>Alt + d</th><td>Slet alle tider i denne session</td></tr>
  <tr><th>Alt + z</th><td>Slet den sidste tid</td></tr>
  <tr><th>Alt + up/down</th><td>Til n&aelig;ste/sidste session.</td></tr>
  <tr><th>Alt + left/rightt</th><td>Vis sidste/n&aelig;ste blanding.</td></tr>
...
<h2>Links</h2>
<ul>
<li><a class="click" href="http://cubingchina.com/">Cubing China, den officielle kinesiske speedcubing side </a></li>
...
<p> Du kan donere via PayPal ved hj&aelig;lp af knappen nedenfor eller<a href="https://www.paypal.me/cs0x7f" class="click"> via. PayPal.me</a>. </p>
