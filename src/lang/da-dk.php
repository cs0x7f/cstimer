...
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">BlandingsGenerator</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_stats">Statistiker</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Tidsfordeling</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Tidsudvikling</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">tegn blanding</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; løs Roux S1</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; løs EOLine</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; løs kryds</strong>. TO_BE_FILLED</li>
