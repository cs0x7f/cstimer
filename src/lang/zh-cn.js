...
var TOOLS_SYNCSEED_HELP = '如果启用，打乱将只取决于种子和打乱设置。通俗的说，如果两个玩家用同一个种子，那么他们会获得一样的打乱公式。';
...
var PROPERTY_ENTERING_STR = '计时器|手动输入|stackmat|MoYuTimer|虚拟魔方|蓝牙魔方|qCube|GAN Smart Timer';
...
var STATS_SSMGR_OPS = '重命名|新建|分割|合并|删除|排序';
...
var STATS_STRING = '最快|当前|最慢|该统计信息由csTimer自动生成于%Y年%M月%D日|还原/总数：%d|单次时间|%mk次平均|%mk次去尾|总去尾：%v{ (σ = %sgm)}|总平均：%v|详细时间：|还原于%s至%e|总耗时：%d';
