...
<li><strong data="opt_giiAED">Detecció automàtica d'errors físics</strong>. Some bluetooth cubes will loss some of moves due to hardware failure, csTimer will try to detect such hardware.</li>
</ul>
<h2>Tools detail</h2>
<ul>
<li><strong data="tool_scrgen">ScrambleGenerator</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cfm">Confirmar temps</strong>. TO_BE_FILLED</li>
<li><strong data="tool_hugestats">Estadístiques absolutes</strong>. TO_BE_FILLED</li>
<li><strong data="tool_stats">Estadístiques</strong>. TO_BE_FILLED</li>
<li><strong data="tool_distribution">Distribució de temps</strong>. TO_BE_FILLED</li>
<li><strong data="tool_trend">Tendència de temps</strong>. TO_BE_FILLED</li>
<li><strong data="tool_dlystat">Daily Statistics</strong>. TO_BE_FILLED</li>
<li><strong data="tool_image">Dibuixar barreja</strong>. TO_BE_FILLED</li>
<li><strong data="tool_roux1">Solvers &gt; Solucionar S1 Roux</strong>. TO_BE_FILLED</li>
<li><strong data="tool_eoline">Solvers &gt; Solucionar línia EO</strong>. TO_BE_FILLED</li>
<li><strong data="tool_cross">Solvers &gt; Solucionar creu</strong>. TO_BE_FILLED</li>
...
<li><strong data="tool_giikerutil">Cub Giiker</strong>. TO_BE_FILLED</li>
<li><strong data="tool_if">InsertionFinder</strong>. TO_BE_FILLED</li>
<li><strong data="tool_mtrnm">Metrònom</strong>. TO_BE_FILLED</li>
