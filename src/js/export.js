...
var exportFunc = execMain(function () {
      ...
      msgf.push(
        ff +
          ...
          msgfmt
            .replace(
              "%s",
              nsolv || (size ? Math.ceil(size / 1024) + " KB" : "N/A"),
            )
          ...
          .then(function (val) {
            ...
            for (var i = 0; i < keys.length; i++) {
              ...
              Array.prototype.push.apply(
                arrs[i],
                JSON.parse(
                  LZString.decompressFromEncodedURIComponent(datas[i]),
                ),
              );
            }
            return baseObj;
  ...
  function updateUserInfoFromGGL() {
    ...
    if (!gglData["access_token"]) {
      ...
      gglDataTd.html(
        "Name: " + me["displayName"] + "<br>" + "Email: " + me["emailAddress"],
      );
  ...
  $(function () {
    ...
    kernel.regProp("kernel", "atexpi", ~1, "Auto Export Interval (Solves)", [
      100,
      [50, 100, 200, 500],
      ["50", "100", "200", "500"],
    ]);
