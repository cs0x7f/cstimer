(function() {
    ...
    var ss = [[-(0.5 - wg), -(0.5 - wg)], [(1.5 - wg), -(0.5 - wg)], [-(0.5 - wg), (1.5 - wg)]];
    var ls = [[(2 - wg * 2), 0], [0, (2 - wg * 2)], [-(2 - wg * 2), 0], [0, -(2 - wg * 2)]];

    var facelets = [
        [[ss, -1.5, -1.5, 2, 0], [ss, -1.5, -1.5, 2, 1], [ss, -1.5, -1.5, 2, 2], [ss, -1.5, -1.5, 2, 3], [ls, 0, 0, 2, 0]], 
        [[ss, -1.5, -1.5, 2, 0], [ss, -1.5, -1.5, 2, 1], [ss, -1.5, -1.5, 2, 2], [ss, -1.5, -1.5, 2, 3], [ls, 0, 0, 2, 0]], 
        [[ss, -1.5, -1.5, 2, 0], [ss, -1.5, -1.5, 2, 1], [ss, -1.5, -1.5, 2, 2], [ss, -1.5, -1.5, 2, 3], [ls, 0, 0, 2, 0]], 
        [[ss, -1.5, -1.5, 2, 0], [ss, -1.5, -1.5, 2, 1], [ss, -1.5, -1.5, 2, 2], [ss, -1.5, -1.5, 2, 3], [ls, 0, 0, 2, 0]], 
        [[ss, -1.5, -1.5, 2, 0], [ss, -1.5, -1.5, 2, 1], [ss, -1.5, -1.5, 2, 2], [ss, -1.5, -1.5, 2, 3], [ls, 0, 0, 2, 0]], 
        ...
        function parseScramble(scramble) {
            if (scramble.match(/^\s*$/)) {
                ...
                for (var i = 0; i < moves.length; i++) {
                    scramble.push([moves[i][0], [4, 0, -4][moves[i][2] - 1], 0, 5]);
                }
                return scramble;
            }
        }
