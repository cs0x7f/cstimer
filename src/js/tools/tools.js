...
var tools = execMain(function() {
	...
	function puzzleType(scrambleType) {
		if (/^222(so|[236o]|eg[012]?|nb)$/.exec(scrambleType)) {
			return "222";
		} else if (/^(333(oh?|ni|f[mt]|custom)?|(z[zb]|[coep]|c[om]|2g|ls|tt)?ll|lse(mu)?|2genl?|3gen_[LF]|edges|corners|f2l|lsll2|(zb|wv|eo)ls|roux|RrU|half|easyc|eoline)$/.exec(scrambleType)) {
			return "333";
