...
var stats = (function (kpretty, round) {
    ...
    var floatCfm = (function () {
        ...
        function procMouse(e) {
            ...
            switch (time[0][0]) {
                case 0:
                    cfmOKR.prop("checked", true);
                    break;
                case 2000:
                    cfmP2R.prop("checked", true);
                    break;
                case -1:
                    cfmDNFR.prop("checked", true);
                    break;
            }
    ...
    function procClick(e) {
        ...
        switch (row) {
            case 0:
                setHighlight(idx, 1, 10, true);
                floatCfm.hide();
                break;
            case 1:
                break;
            case 2:
                setHighlight(idx - len1 + 1, len1, len1 * 10, stat1 < 0);
                break;
            case 3:
                setHighlight(idx - len2 + 1, len2, len2 * 10, stat2 < 0);
                break;
        }
    }
    ...
    function infoClick(e) {
        ...
        switch (which.substr(0, 2)) {
            case 'bs':
                setHighlight(bestTimeIndex, 1, 10, true);
                break;
            case 'cs':
                setHighlight(times.length - 1, 1, 10, true);
                break;
            case 'bm':
                setHighlight(bestAvgIndex[idx], -avgSizes[idx], -avgSizes[idx] * 10, true);
                break;
            case 'cm':
                setHighlight(times.length + avgSizes[idx], -avgSizes[idx], -avgSizes[idx] * 10, true);
                break;
            case 'ba':
                setHighlight(bestAvgIndex[idx], avgSizes[idx], avgSizes[idx] * 10, false);
                break;
            case 'ca':
                setHighlight(times.length - avgSizes[idx], avgSizes[idx], avgSizes[idx] * 10, false);
                break;
            case 'tt':
                getStats();
                break;
